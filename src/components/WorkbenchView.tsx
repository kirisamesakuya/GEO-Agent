    ...
    <div className="geo-page-content overflow-y-auto h-full space-y-4">
      ...
      <div className="flex flex-wrap items-end justify-between gap-2">
        <div className="flex items-center gap-3">
          <LayoutDashboard className="w-6 h-6 text-[var(--color-accent)]" aria-hidden />
          <div>
            <h2 className="text-lg font-bold">工作台</h2>
            <p className="text-xs text-[var(--neutral-text-03)]">
              {displayBrand} · 数据驾驶舱
              {lastRefreshedAt && (
                <>
                  {' '}
                  · 更新于 {formatRefreshTime(lastRefreshedAt)} · 每 15s 刷新
                </>
              )}
            </p>
          </div>

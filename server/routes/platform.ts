...
export function registerPlatformRoutes(app: Express) {
  ...
  app.get('/api/platform/dashboard', async (_req, res) => {
  ...
  app.get('/api/platform/agent-skill-runs', async (_req, res) => {
    res.json({ runs: await listAgentSkillRuns() });
  });

  app.get('/api/platform/local-automation-runs', async (_req, res) => {
  ...
  app.get('/api/platform/ai-credits', async (_req, res) => {
  ...
  app.get('/api/platform/merchants', async (_req, res) => {
  ...
  app.get('/api/platform/provider-applications', async (_req, res) => {
  ...
  app.get('/api/platform/deposit-requests', async (_req, res) => {
  ...
  app.get('/api/platform/members', async (_req, res) => {
